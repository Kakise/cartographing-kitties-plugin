...
- Tree-sitter indexing baselines: [CocoIndex Realtime](https://github.com/cocoindex-io/realtime-codebase-indexing), [GitNexus client-side knowledge graph](https://github.com/abhigyanpatwari/GitNexus), [legacy runtime Codebase Index](https://github.com/Helweg/legacy-runtime-codebase-index)
