...
name: kitty-lfg
description: |
  Full autonomous engineering workflow — plan, work, review with Cartographing Kittens-first inline-first orchestration. Requires the Cartographing Kittens MCP server (`uvx cartographing-kittens`).
